...
Source0  : https://github.com/paullouisageneau/libdatachannel/archive/v0.22.4/libdatachannel-0.22.4.tar.gz
...
%prep
%setup -q -n libdatachannel-0.22.4
cd %{_builddir}/libdatachannel-0.22.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736866664
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libdatachannel.so.0.22.4
