...
Version  : 0.22.5
Release  : 17
URL      : https://github.com/paullouisageneau/libdatachannel/archive/v0.22.5/libdatachannel-0.22.5.tar.gz
Source0  : https://github.com/paullouisageneau/libdatachannel/archive/v0.22.5/libdatachannel-0.22.5.tar.gz
...
%prep
%setup -q -n libdatachannel-0.22.5
cd %{_builddir}/libdatachannel-0.22.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739545032
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libdatachannel.so.0.22.5
