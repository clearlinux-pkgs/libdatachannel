...
Version  : 0.22.3
Release  : 13
URL      : https://github.com/paullouisageneau/libdatachannel/archive/v0.22.3/libdatachannel-0.22.3.tar.gz
Source0  : https://github.com/paullouisageneau/libdatachannel/archive/v0.22.3/libdatachannel-0.22.3.tar.gz
...
%prep
%setup -q -n libdatachannel-0.22.3
cd %{_builddir}/libdatachannel-0.22.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733397550
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libdatachannel.so.0.22.3
