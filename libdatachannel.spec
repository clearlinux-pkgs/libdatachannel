...
Version  : 0.21.1
Release  : 1
URL      : https://github.com/paullouisageneau/libdatachannel/archive/v0.21.1/libdatachannel-0.21.1.tar.gz
Source0  : https://github.com/paullouisageneau/libdatachannel/archive/v0.21.1/libdatachannel-0.21.1.tar.gz
...
%prep
%setup -q -n libdatachannel-0.21.1
cd %{_builddir}/libdatachannel-0.21.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1716940689
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libdatachannel.so.0.21.1
